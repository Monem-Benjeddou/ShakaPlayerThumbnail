...
namespace ShakaPlayerThumbnail.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = new Tuple<string, string>("/data/video/video.mp4", returnedVttFilePath);
